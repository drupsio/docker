...
${COLOR_BLUE}\nDocker Registry${COLOR_NONE}\
${COLOR_GREEN}\n Username\t${COLOR_NONE} - ${COLOR_GREEN}${DOCKER_REGISTRY_USER}${COLOR_NONE}\
${COLOR_GREEN}\n Password\t${COLOR_NONE} - ${COLOR_GREEN}${DOCKER_REGISTRY_PASS}${COLOR_NONE}\
